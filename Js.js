    ...
    function Comenzar() {
        ...
        if (Jugador1.value == "") {
            ...
            if (Jugador2.value == "") {
                ...
                turno = 1;
                document.getElementById("turnoJugador").innerHTML = "Turno de  " + Jugador1.value;
            }
        }
    }
};
function colocar(boton) {
    if (bandera == true) {
        if (turno == 1 && boton.value == "I") {
            turno = 2;
            document.getElementById("turnoJugador").innerHTML = "Turno de  " + Jugador2.value;
            boton.value = "X";
    ...
    function empate() {
        if (bandera == true) {
            if (tab[0].value != "I" && tab[1].value != "I" && tab[2].value != "I" && tab[3].value != "I" && tab[4].value != "I" && tab[5].value != "I" && tab[6].value != "I" && tab[7].value != "I" && tab[8].value != "I") {
                setTimeout(() => {
...
function revisar() {
    ...
    function ganador(win) {
        document.getElementById("turnoJugador").innerHTML = "Ha ganado" + win;
        document.getElementById("Iniciar").value = "Volver a jugar";
        document.getElementById("tablero").setAttribute('style', 'border: solid 0.3em black;'); 
    }
}
